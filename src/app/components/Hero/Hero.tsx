...
const Hero: FC = () => {
  return (
    <header className="flex flex-col items-center relative w-full hero">
      ...
      <div className="flex flex-col w-2/3 gap-8 h-screen justify-center -mt-10">
        <span className="text-5xl">hi i'm</span>
        <h1 className="text-[7rem] leading-none tracking-wider font-[family-name:var(--font-universal-expansion)]">
          Cass
        </h1>
