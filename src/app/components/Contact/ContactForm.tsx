...
const ContactForm: FC = () => {
  ...
  return (
    <section className="flex flex-col items-center gap-6 w-full border-2 md:border-none">
      ...
      <form
        ...
        onSubmit={sendEmail}
        noValidate
        className="flex flex-col gap-4 p-4 w-full lg:w-2/3 xl:w-1/2 2xl:w-1/3 rounded-lg mt-2 border-t-[1px] border-t-brown bg-dark-brown-1"
      >
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="p-2 text-md bg-dark-brown-1 focus:bg-dark-brown-2 rounded border-[1px] border-brown focus:outline-none"
          />
        </div>
        ...
        <div>
          <input
            type="submit"
            value="Send"
            className="py-1 px-2 border-[1px] border-brown w-fit rounded-lg text-beige hover:bg-dark-brown-2 hover:text-white hover:cursor-pointer"
          />
        </div>
      </form>
    </section>
